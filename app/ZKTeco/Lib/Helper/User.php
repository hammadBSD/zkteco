...
{
    /**
     * @param \App\ZKTeco\Lib\ZKTeco $self
     ...
     * @return bool|mixed
     */
    static public function set(\App\ZKTeco\Lib\ZKTeco $self, $uid, $userid, $name, $password, $role = Util::LEVEL_USER, $cardno = 0)
    {
...
//        die($command_string);
     ...
     * @return bool|mixed
     */
    static public function clear(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    static public function clearAdmin(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     * @return bool|mixed
     */
    static public function remove(\App\ZKTeco\Lib\ZKTeco $self, $uid)
    {
        $self->_section = __METHOD__;

...
class Util
{
   ...
   * @return bool|number
   */
  static public function getSize(\App\ZKTeco\Lib\ZKTeco $self)
  {
   ...
   * @return string
   */
  static public function recData(\App\ZKTeco\Lib\ZKTeco $self, $maxErrors = 10, $first = true)
  {
    $data = '';
   ...
   * @param int $bytes
   */
  static private function logReceived(\App\ZKTeco\Lib\ZKTeco $self, $received, $bytes)
  {
   ...
   * @param string $str
   */
  static private function logger(\App\ZKTeco\Lib\ZKTeco $self, $str)
  {

...
class Fingerprint
{
     ...
     */
    static public function get(\App\ZKTeco\Lib\ZKTeco $self, $uid)
    {
     ...
     */
    static public function set(\App\ZKTeco\Lib\ZKTeco $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
     ...
     */
    static public function remove(\App\ZKTeco\Lib\ZKTeco $self, $uid, array $data)
    {
        $self->_section = __METHOD__;
     ...
     */
    private function _getFinger(\App\ZKTeco\Lib\ZKTeco $self, $uid, $finger)
    {
     ...
     */
    private function _setFinger(\App\ZKTeco\Lib\ZKTeco $self, $data)
    {
     ...
     */
    private function _removeFinger(\App\ZKTeco\Lib\ZKTeco $self, $uid, $finger)
    {
     ...
     */
    private function _checkFinger(\App\ZKTeco\Lib\ZKTeco $self, $uid, $finger)
    {
        $fingerPrint = new Fingerprint();

...
class Device
{
     ...
     */
    static public function name(\App\ZKTeco\Lib\ZKTeco $self)
    {
     ...
     */
    static public function enable(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    static public function disable(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function powerOff(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function restart(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function sleep(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function resume(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function testVoice(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function clearLCD(\App\ZKTeco\Lib\ZKTeco $self)
    {
        $self->_section = __METHOD__;
     ...
     */
    public static function writeLCD(\App\ZKTeco\Lib\ZKTeco $self, $rank, $text)
    {
        $self->_section = __METHOD__;
